...
pub fn NavBar() -> impl IntoView {
    ...
    view! {
        <nav
            aria-label="Primary"
            class="fixed inset-x-0 top-0 z-50 flex flex-col items-start gap-2 py-4 pr-4 pl-6 font-mono text-sm lowercase tracking-[0.2em] sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:py-6 sm:pr-6 sm:pl-24"
            style=style
        >
